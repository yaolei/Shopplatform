<template>
		...
		<main class="mine_layout">
            ...
            <el-row :gutter="20">
                ...
                <el-col :span="13">
                    ...
                    <el-input v-model="carOwner"  id='me' placeholder="(请输入完整姓名)">
                        </el-input>
                    </div>
                </el-col>
            </el-row>  
  ...
  <!--           <div class="grid-content bg-purple" style='width: 80%;font-size:18px;padding-left: 15px;min-height:0px;padding-top: 5px;'>
            ...
            <el-row :gutter="20">
                ...
                <el-col :span="5" style="padding-right:0px">
                    <div class="grid-content bg-purple " style='padding-top: 5px;text-align: center;font-size:16px;color:#c3c3c3'>证件类型</div>
                </el-col>
                <el-col :span="13">
                    <div class="grid-content bg-purple"
                     style='text-align:left;font-size:14px;'>
                     <!--    <el-input  v-model="carType" type="number"  label="" id='me1' >
                        </el-input> -->
                        身份证
                    </div>
                </el-col>              
            ...
            <el-row :gutter="20">
                ...
                <el-col :span="5" style="padding-right:0px">
                    <div class="grid-content bg-purple " style='padding-top: 5px;text-align: center;font-size:16px;color:#c3c3c3'>证件号</div>
                </el-col>
                <el-col :span="13">
                    <div class="grid-content bg-purple"
                     style='text-align: left;font-size:24px;'>
                        <el-input  v-model="carNum" type="number"  label="" id='me1' placeholder="(请输入证件号)">
                        </el-input>
                    </div>
                </el-col>              
            </el-row>        
		...
		methods:{
			...
			submitVal () {
                if (this.carNum == '' || this.carOwner == '')  {
                    this.$message('信息必须填写完整');
                } else {
                    let _this = this;
                    let recGoodsData = {
                        True_Name: this.carOwner,
                        Id_Card: this.carNum
                    }
                    _this.$http.post('User/Member/RealnameVerify',
                    ...
                    , {
                        ...
                        if (res.data.status) {
                            let redirect = decodeURIComponent(_this.$route.query.redirect || '/SetPayPassWord');
                            _this.$router.push({
                                path: redirect
                            });
                        } else {
