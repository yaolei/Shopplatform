...
module.exports = () => {
    ...
    route.get('/category', (req, res) => {
        debugger;
        getCateNamesDatas( res);
    });

    function getCateNamesDatas( res) {
        debugger;
        // $.ajax({  
        //     type : "POST",  
        //     url : server_url + "/api/Mall/Category/List",  
        //     data : '',  
    ...
    // route.get('/createAddress', (req, res) => {
    // });
